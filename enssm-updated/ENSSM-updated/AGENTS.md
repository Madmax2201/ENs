## Project: Higher School for Teachers of Deaf and Mute (ENS-SM) Website

### Current Implementation
- **HomePage**: Complete informational website for المدرسة العليا لأساتذة الصم والبكم
  - **Language Toggle**: Button in navigation to switch between English and Arabic (RTL support)
  - Hero section with school name in English and Arabic
  - Stats section (400+ students, 14 specializations, 2-year program, 292 first graduates)
  - About section with mission and key training areas
  - Programs section with all 14 specializations (bilingual)
  - Admission section with process steps and requirements
  - Contact section with location, Facebook, and ministry links
  - **Wajihat (Centers) Section**: Showcases 5 innovation/excellence hubs:
    1. House of Entrepreneurship - Startup culture and mentorship
    2. Business Incubator - Concept to market support
    3. Artificial Intelligence House - AI research for deaf education
    4. Technology & Innovation Support Center (TISC) - Tech support and patents
    5. Cultural & Scientific Centers - Cultural exchange and collaboration
    Each center displays director photo, description, and key achievements
  - Footer with quick links and official links (including MESRS Platforms link)
  - Responsive design with mobile navigation
  - Smooth scrolling navigation
  - Full RTL layout support when Arabic is selected

### Key Information Sources
- Official Facebook: https://www.facebook.com/ENS.SourdsMuets.dz/
- Ministry of Higher Education: https://www.mesrs.dz
- Location: Beni Messous, Algiers, Algeria
- Inaugurated: October 16, 2022
